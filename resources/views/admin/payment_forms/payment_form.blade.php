@extends('home')
<head>
    <title>Formas de pago | Trazenta</title>
</head>
@section('content')
                            ...
                            @if ($perm_btn['modify']==1 || $perm_btn['erase']==1)
                                <td>
                                    @if ($perm_btn['modify']==1)
                                        <button href="#|" class="btn btn-warning" onclick="editarforma({{$paymentforms->id}})" ><i class="fa-solid fa-pen-to-square"></i></button>
                                    @endif
                                    @if ($perm_btn['erase']==1)
                                        <button href="#|" class="btn btn-danger" onclick="eliminarforma({{$paymentforms->id}})"><i class="fa-solid fa-trash"></i></button>
                                    @endif
                                </td>
                            @endif
                        </tr>
