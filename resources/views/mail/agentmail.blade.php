...
<body>
    <div class="email-container">
        ...
        <h1>Estimado Armando Dicarlo</h1>
        <div class="content">
            <p>Esperamos que este mensaje le encuentre bien.</p>
            <p>Adjunto a este correo encontrará los recibos correspondientes a sus comisiones del período [mes/año]. Le agradeceremos que nos envíe su factura correspondiente a la brevedad, para proceder con el pago en tiempo y forma.</p>
