...
<head>
    ...
    <meta name="description" content="Trazenta">
    <link rel="icon" href="{{ URL::asset('img/logo.ico') }}">
    <title>@yield('title','Sistema') | Trazenta</title>
    <!-- CSRF Token -->
    ...
    <script src="https://kit.fontawesome.com/f9e25df27c.js" crossorigin="anonymous"></script>
